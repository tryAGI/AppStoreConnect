...
namespace AppStoreConnect
{
    public partial class SubscriptionsClient
    {
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement s_SubscriptionsWinBackOffersGetToManyRelationshipSecurityRequirement0 =
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement[] s_SubscriptionsWinBackOffersGetToManyRelationshipSecurityRequirements =
            new global::AppStoreConnect.EndPointSecurityRequirement[]
            {                s_SubscriptionsWinBackOffersGetToManyRelationshipSecurityRequirement0,
            };
        partial void PrepareSubscriptionsWinBackOffersGetToManyRelationshipArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? limit,
            ref string id);
        partial void PrepareSubscriptionsWinBackOffersGetToManyRelationshipRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? limit,
            string id);
        partial void ProcessSubscriptionsWinBackOffersGetToManyRelationshipResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSubscriptionsWinBackOffersGetToManyRelationshipResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.SubscriptionWinBackOffersLinkagesResponse> SubscriptionsWinBackOffersGetToManyRelationshipAsync(
            string id,
            int? limit = default,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await SubscriptionsWinBackOffersGetToManyRelationshipAsResponseAsync(
                id: id,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AppStoreConnect.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.SubscriptionWinBackOffersLinkagesResponse>> SubscriptionsWinBackOffersGetToManyRelationshipAsResponseAsync(
            string id,
            int? limit = default,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareSubscriptionsWinBackOffersGetToManyRelationshipArguments(
            ...
            var __authorizations = global::AppStoreConnect.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SubscriptionsWinBackOffersGetToManyRelationshipSecurityRequirements,
                operationName: "SubscriptionsWinBackOffersGetToManyRelationshipAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSubscriptionsWinBackOffersGetToManyRelationshipRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AppStoreConnect.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SubscriptionsWinBackOffersGetToManyRelationship",
                                methodName: "SubscriptionsWinBackOffersGetToManyRelationshipAsync",
                                pathTemplate: "$\"/v1/subscriptions/{id}/relationships/winBackOffers\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSubscriptionsWinBackOffersGetToManyRelationshipResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSubscriptionsWinBackOffersGetToManyRelationshipResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::AppStoreConnect.SubscriptionWinBackOffersLinkagesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.SubscriptionWinBackOffersLinkagesResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::AppStoreConnect.SubscriptionWinBackOffersLinkagesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        /// <summary>
        /// Wraps SubscriptionsWinBackOffersGetToManyRelationshipAsync as an IAsyncEnumerable&lt;global::AppStoreConnect.SubscriptionWinBackOffersLinkagesResponseDataItem&gt; that follows the response's next-page URL.
        /// </summary>
        /// <param name="limit"></param>
        /// <param name="id"></param>
        /// <param name="requestOptions">Options forwarded to every page request.</param>
        /// <param name="cancellationToken"></param>
        public global::System.Collections.Generic.IAsyncEnumerable<global::AppStoreConnect.SubscriptionWinBackOffersLinkagesResponseDataItem> SubscriptionsWinBackOffersGetToManyRelationshipAutoPagingAsync(
            string id,             int? limit = default,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::AppStoreConnect.AutoSDKPager.NextUrlAsync<global::AppStoreConnect.SubscriptionWinBackOffersLinkagesResponse, global::AppStoreConnect.SubscriptionWinBackOffersLinkagesResponseDataItem>(
                fetchPage: (__nextUrl, __ct) => SubscriptionsWinBackOffersGetToManyRelationshipAsync(
                    limit: limit,
                    id: id,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::AppStoreConnect.SubscriptionWinBackOffersLinkagesResponseDataItem>?)__response.Data,
