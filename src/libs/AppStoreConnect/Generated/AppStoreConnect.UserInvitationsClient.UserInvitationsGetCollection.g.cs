...
namespace AppStoreConnect
{
    public partial class UserInvitationsClient
    {
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement s_UserInvitationsGetCollectionSecurityRequirement0 =
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement[] s_UserInvitationsGetCollectionSecurityRequirements =
            new global::AppStoreConnect.EndPointSecurityRequirement[]
            {                s_UserInvitationsGetCollectionSecurityRequirement0,
            };
        partial void PrepareUserInvitationsGetCollectionArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Collections.Generic.IList<string>? filterEmail,
            global::System.Collections.Generic.IList<global::AppStoreConnect.UserInvitationsGetCollectionFilterRole>? filterRoles,
            global::System.Collections.Generic.IList<string>? filterVisibleApps,
            global::System.Collections.Generic.IList<global::AppStoreConnect.UserInvitationsGetCollectionSortItem>? sort,
            global::System.Collections.Generic.IList<global::AppStoreConnect.UserInvitationsGetCollectionFieldsUserInvitation>? fieldsUserInvitations,
            global::System.Collections.Generic.IList<global::AppStoreConnect.UserInvitationsGetCollectionFieldsApp>? fieldsApps,
            ref int? limit,
            global::System.Collections.Generic.IList<global::AppStoreConnect.UserInvitationsGetCollectionIncludeItem>? include,
            ref int? limitVisibleApps);
        partial void PrepareUserInvitationsGetCollectionRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? limit,
            global::System.Collections.Generic.IList<global::AppStoreConnect.UserInvitationsGetCollectionIncludeItem>? include,
            int? limitVisibleApps);
        partial void ProcessUserInvitationsGetCollectionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUserInvitationsGetCollectionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.UserInvitationsResponse> UserInvitationsGetCollectionAsync(
        ...
        {
            var __response = await UserInvitationsGetCollectionAsResponseAsync(
                filterEmail: filterEmail,
                filterRoles: filterRoles,
                filterVisibleApps: filterVisibleApps,
                sort: sort,
                fieldsUserInvitations: fieldsUserInvitations,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AppStoreConnect.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.UserInvitationsResponse>> UserInvitationsGetCollectionAsResponseAsync(
            global::System.Collections.Generic.IList<string>? filterEmail = default,
            global::System.Collections.Generic.IList<global::AppStoreConnect.UserInvitationsGetCollectionFilterRole>? filterRoles = default,
            global::System.Collections.Generic.IList<string>? filterVisibleApps = default,
            global::System.Collections.Generic.IList<global::AppStoreConnect.UserInvitationsGetCollectionSortItem>? sort = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareUserInvitationsGetCollectionArguments(
                ...
                limit: ref limit,
                include: include,
                limitVisibleApps: ref limitVisibleApps);


            var __authorizations = global::AppStoreConnect.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_UserInvitationsGetCollectionSecurityRequirements,
                operationName: "UserInvitationsGetCollectionAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("filter[roles]", filterRoles, selector: static x => x.ToValueString(), delimiter: ",", explode: false)
                                .AddOptionalParameter("filter[visibleApps]", filterVisibleApps, delimiter: ",", explode: false)
                                .AddOptionalParameter("sort", sort, selector: static x => x.ToValueString(), delimiter: ",", explode: false)
                                .AddOptionalParameter("fields[userInvitations]", fieldsUserInvitations, selector: static x => x.ToValueString(), delimiter: ",", explode: false)
                                ...
                                .AddOptionalParameter("limit[visibleApps]", limitVisibleApps?.ToString())
                                ;
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUserInvitationsGetCollectionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AppStoreConnect.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UserInvitationsGetCollectionAsync",
                                pathTemplate: "\"/v1/userInvitations\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUserInvitationsGetCollectionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUserInvitationsGetCollectionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::AppStoreConnect.UserInvitationsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.UserInvitationsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::AppStoreConnect.UserInvitationsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
