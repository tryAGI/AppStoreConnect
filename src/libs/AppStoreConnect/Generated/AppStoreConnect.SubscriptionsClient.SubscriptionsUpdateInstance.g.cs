...
namespace AppStoreConnect
{
    public partial class SubscriptionsClient
    {
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement s_SubscriptionsUpdateInstanceSecurityRequirement0 =
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement[] s_SubscriptionsUpdateInstanceSecurityRequirements =
            new global::AppStoreConnect.EndPointSecurityRequirement[]
            {                s_SubscriptionsUpdateInstanceSecurityRequirement0,
            };
        partial void PrepareSubscriptionsUpdateInstanceArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            global::AppStoreConnect.SubscriptionUpdateRequest request);
        partial void PrepareSubscriptionsUpdateInstanceRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::AppStoreConnect.SubscriptionUpdateRequest request);
        partial void ProcessSubscriptionsUpdateInstanceResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSubscriptionsUpdateInstanceResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.SubscriptionResponse> SubscriptionsUpdateInstanceAsync(
            string id,
        ...
        {
            var __response = await SubscriptionsUpdateInstanceAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AppStoreConnect.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.SubscriptionResponse>> SubscriptionsUpdateInstanceAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSubscriptionsUpdateInstanceArguments(
            ...
            var __authorizations = global::AppStoreConnect.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SubscriptionsUpdateInstanceSecurityRequirements,
                operationName: "SubscriptionsUpdateInstanceAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSubscriptionsUpdateInstanceRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AppStoreConnect.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SubscriptionsUpdateInstance",
                                methodName: "SubscriptionsUpdateInstanceAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSubscriptionsUpdateInstanceResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSubscriptionsUpdateInstanceResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.SubscriptionResponse> SubscriptionsUpdateInstanceAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::AppStoreConnect.SubscriptionUpdateRequest
            {
                Data = data,
                Included = included,
            };

            return await SubscriptionsUpdateInstanceAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
