...
namespace AppStoreConnect
{
    public partial class BackgroundAssetUploadFilesClient
    {
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement s_BackgroundAssetUploadFilesGetInstanceSecurityRequirement0 =
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement[] s_BackgroundAssetUploadFilesGetInstanceSecurityRequirements =
            new global::AppStoreConnect.EndPointSecurityRequirement[]
            {                s_BackgroundAssetUploadFilesGetInstanceSecurityRequirement0,
            };
        partial void PrepareBackgroundAssetUploadFilesGetInstanceArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Collections.Generic.IList<global::AppStoreConnect.BackgroundAssetUploadFilesGetInstanceFieldsBackgroundAssetUploadFile>? fieldsBackgroundAssetUploadFiles,
            ref string id);
        partial void PrepareBackgroundAssetUploadFilesGetInstanceRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Collections.Generic.IList<global::AppStoreConnect.BackgroundAssetUploadFilesGetInstanceFieldsBackgroundAssetUploadFile>? fieldsBackgroundAssetUploadFiles,
            string id);
        partial void ProcessBackgroundAssetUploadFilesGetInstanceResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBackgroundAssetUploadFilesGetInstanceResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.BackgroundAssetUploadFileResponse> BackgroundAssetUploadFilesGetInstanceAsync(
            string id,
        ...
        {
            var __response = await BackgroundAssetUploadFilesGetInstanceAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AppStoreConnect.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.BackgroundAssetUploadFileResponse>> BackgroundAssetUploadFilesGetInstanceAsResponseAsync(
            string id,
            global::System.Collections.Generic.IList<global::AppStoreConnect.BackgroundAssetUploadFilesGetInstanceFieldsBackgroundAssetUploadFile>? fieldsBackgroundAssetUploadFiles = default,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareBackgroundAssetUploadFilesGetInstanceArguments(
            ...
            var __authorizations = global::AppStoreConnect.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_BackgroundAssetUploadFilesGetInstanceSecurityRequirements,
                operationName: "BackgroundAssetUploadFilesGetInstanceAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBackgroundAssetUploadFilesGetInstanceRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AppStoreConnect.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BackgroundAssetUploadFilesGetInstance",
                                methodName: "BackgroundAssetUploadFilesGetInstanceAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBackgroundAssetUploadFilesGetInstanceResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBackgroundAssetUploadFilesGetInstanceResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
