...
{
    /// <inheritdoc />
    public class IncludedItem59JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::AppStoreConnect.IncludedItem59>
    {
        /// <inheritdoc />
        public override global::AppStoreConnect.IncludedItem59 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::AppStoreConnect.BetaTesterResponseIncludedItemDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::AppStoreConnect.BetaTesterResponseIncludedItemDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::AppStoreConnect.BetaTesterResponseIncludedItemDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::AppStoreConnect.App? apps = default;
            if (discriminator?.Type == global::AppStoreConnect.BetaTesterResponseIncludedItemDiscriminatorType.Apps)
            {
            ...
            if (discriminator?.Type == global::AppStoreConnect.BetaTesterResponseIncludedItemDiscriminatorType.BetaGroups)
            {
            ...
            if (discriminator?.Type == global::AppStoreConnect.BetaTesterResponseIncludedItemDiscriminatorType.Builds)
            {
            ...
            var __value = new global::AppStoreConnect.IncludedItem59(
                discriminator?.Type,
                apps,
        ...
        public override void Write(
            ...
            global::AppStoreConnect.IncludedItem59 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
