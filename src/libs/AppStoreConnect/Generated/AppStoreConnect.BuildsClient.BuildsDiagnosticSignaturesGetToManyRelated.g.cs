...
namespace AppStoreConnect
{
    public partial class BuildsClient
    {
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement s_BuildsDiagnosticSignaturesGetToManyRelatedSecurityRequirement0 =
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement[] s_BuildsDiagnosticSignaturesGetToManyRelatedSecurityRequirements =
            new global::AppStoreConnect.EndPointSecurityRequirement[]
            {                s_BuildsDiagnosticSignaturesGetToManyRelatedSecurityRequirement0,
            };
        partial void PrepareBuildsDiagnosticSignaturesGetToManyRelatedArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Collections.Generic.IList<global::AppStoreConnect.BuildsDiagnosticSignaturesGetToManyRelatedFilterDiagnosticTypeItem>? filterDiagnosticType,
            global::System.Collections.Generic.IList<global::AppStoreConnect.BuildsDiagnosticSignaturesGetToManyRelatedFieldsDiagnosticSignature>? fieldsDiagnosticSignatures,
            ref int? limit,
            ref string id);
        partial void PrepareBuildsDiagnosticSignaturesGetToManyRelatedRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? limit,
            string id);
        partial void ProcessBuildsDiagnosticSignaturesGetToManyRelatedResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBuildsDiagnosticSignaturesGetToManyRelatedResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.DiagnosticSignaturesResponse> BuildsDiagnosticSignaturesGetToManyRelatedAsync(
            string id,
        ...
        {
            var __response = await BuildsDiagnosticSignaturesGetToManyRelatedAsResponseAsync(
                id: id,
                filterDiagnosticType: filterDiagnosticType,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AppStoreConnect.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.DiagnosticSignaturesResponse>> BuildsDiagnosticSignaturesGetToManyRelatedAsResponseAsync(
            string id,
            global::System.Collections.Generic.IList<global::AppStoreConnect.BuildsDiagnosticSignaturesGetToManyRelatedFilterDiagnosticTypeItem>? filterDiagnosticType = default,
            global::System.Collections.Generic.IList<global::AppStoreConnect.BuildsDiagnosticSignaturesGetToManyRelatedFieldsDiagnosticSignature>? fieldsDiagnosticSignatures = default,
            int? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareBuildsDiagnosticSignaturesGetToManyRelatedArguments(
            ...
            var __authorizations = global::AppStoreConnect.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_BuildsDiagnosticSignaturesGetToManyRelatedSecurityRequirements,
                operationName: "BuildsDiagnosticSignaturesGetToManyRelatedAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                .AddOptionalParameter("filter[diagnosticType]", filterDiagnosticType, selector: static x => x.ToValueString(), delimiter: ",", explode: false)
                                .AddOptionalParameter("fields[diagnosticSignatures]", fieldsDiagnosticSignatures, selector: static x => x.ToValueString(), delimiter: ",", explode: false)
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBuildsDiagnosticSignaturesGetToManyRelatedRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AppStoreConnect.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "BuildsDiagnosticSignaturesGetToManyRelatedAsync",
                                pathTemplate: "$\"/v1/builds/{id}/diagnosticSignatures\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBuildsDiagnosticSignaturesGetToManyRelatedResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBuildsDiagnosticSignaturesGetToManyRelatedResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::AppStoreConnect.DiagnosticSignaturesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.DiagnosticSignaturesResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::AppStoreConnect.DiagnosticSignaturesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::AppStoreConnect.DiagnosticSignature> BuildsDiagnosticSignaturesGetToManyRelatedAutoPagingAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::AppStoreConnect.AutoSDKPager.NextUrlAsync<global::AppStoreConnect.DiagnosticSignaturesResponse, global::AppStoreConnect.DiagnosticSignature>(
                fetchPage: (__nextUrl, __ct) => BuildsDiagnosticSignaturesGetToManyRelatedAsync(
                    filterDiagnosticType: filterDiagnosticType,
                    fieldsDiagnosticSignatures: fieldsDiagnosticSignatures,
                    limit: limit,
                    id: id,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::AppStoreConnect.DiagnosticSignature>?)__response.Data,
