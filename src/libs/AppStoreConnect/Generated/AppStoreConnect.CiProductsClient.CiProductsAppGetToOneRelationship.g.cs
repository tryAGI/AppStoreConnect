...
namespace AppStoreConnect
{
    public partial class CiProductsClient
    {
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement s_CiProductsAppGetToOneRelationshipSecurityRequirement0 =
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement[] s_CiProductsAppGetToOneRelationshipSecurityRequirements =
            new global::AppStoreConnect.EndPointSecurityRequirement[]
            {                s_CiProductsAppGetToOneRelationshipSecurityRequirement0,
            };
        partial void PrepareCiProductsAppGetToOneRelationshipArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id);
        partial void PrepareCiProductsAppGetToOneRelationshipRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessCiProductsAppGetToOneRelationshipResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCiProductsAppGetToOneRelationshipResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.CiProductAppLinkageResponse> CiProductsAppGetToOneRelationshipAsync(
            string id,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CiProductsAppGetToOneRelationshipAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AppStoreConnect.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.CiProductAppLinkageResponse>> CiProductsAppGetToOneRelationshipAsResponseAsync(
            string id,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCiProductsAppGetToOneRelationshipArguments(
            ...
            var __authorizations = global::AppStoreConnect.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CiProductsAppGetToOneRelationshipSecurityRequirements,
                operationName: "CiProductsAppGetToOneRelationshipAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCiProductsAppGetToOneRelationshipRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AppStoreConnect.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CiProductsAppGetToOneRelationship",
                                methodName: "CiProductsAppGetToOneRelationshipAsync",
                                pathTemplate: "$\"/v1/ciProducts/{id}/relationships/app\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCiProductsAppGetToOneRelationshipResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCiProductsAppGetToOneRelationshipResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::AppStoreConnect.CiProductAppLinkageResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.CiProductAppLinkageResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::AppStoreConnect.CiProductAppLinkageResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
