...
namespace AppStoreConnect
{
    public partial class InAppPurchasePriceSchedulesClient
    {
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement s_InAppPurchasePriceSchedulesBaseTerritoryGetToOneRelatedSecurityRequirement0 =
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement[] s_InAppPurchasePriceSchedulesBaseTerritoryGetToOneRelatedSecurityRequirements =
            new global::AppStoreConnect.EndPointSecurityRequirement[]
            {                s_InAppPurchasePriceSchedulesBaseTerritoryGetToOneRelatedSecurityRequirement0,
            };
        partial void PrepareInAppPurchasePriceSchedulesBaseTerritoryGetToOneRelatedArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Collections.Generic.IList<global::AppStoreConnect.InAppPurchasePriceSchedulesBaseTerritoryGetToOneRelatedFieldsTerritorie>? fieldsTerritories,
            ref string id);
        partial void PrepareInAppPurchasePriceSchedulesBaseTerritoryGetToOneRelatedRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Collections.Generic.IList<global::AppStoreConnect.InAppPurchasePriceSchedulesBaseTerritoryGetToOneRelatedFieldsTerritorie>? fieldsTerritories,
            string id);
        partial void ProcessInAppPurchasePriceSchedulesBaseTerritoryGetToOneRelatedResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessInAppPurchasePriceSchedulesBaseTerritoryGetToOneRelatedResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.TerritoryResponse> InAppPurchasePriceSchedulesBaseTerritoryGetToOneRelatedAsync(
            string id,
        ...
        {
            var __response = await InAppPurchasePriceSchedulesBaseTerritoryGetToOneRelatedAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AppStoreConnect.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.TerritoryResponse>> InAppPurchasePriceSchedulesBaseTerritoryGetToOneRelatedAsResponseAsync(
            string id,
            global::System.Collections.Generic.IList<global::AppStoreConnect.InAppPurchasePriceSchedulesBaseTerritoryGetToOneRelatedFieldsTerritorie>? fieldsTerritories = default,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareInAppPurchasePriceSchedulesBaseTerritoryGetToOneRelatedArguments(
            ...
            var __authorizations = global::AppStoreConnect.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_InAppPurchasePriceSchedulesBaseTerritoryGetToOneRelatedSecurityRequirements,
                operationName: "InAppPurchasePriceSchedulesBaseTerritoryGetToOneRelatedAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareInAppPurchasePriceSchedulesBaseTerritoryGetToOneRelatedRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AppStoreConnect.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "InAppPurchasePriceSchedulesBaseTerritoryGetToOneRelated",
                                methodName: "InAppPurchasePriceSchedulesBaseTerritoryGetToOneRelatedAsync",
                                pathTemplate: "$\"/v1/inAppPurchasePriceSchedules/{id}/baseTerritory\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessInAppPurchasePriceSchedulesBaseTerritoryGetToOneRelatedResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessInAppPurchasePriceSchedulesBaseTerritoryGetToOneRelatedResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::AppStoreConnect.TerritoryResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.TerritoryResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::AppStoreConnect.TerritoryResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
