...
namespace AppStoreConnect
{
    public partial class WebhooksClient
    {
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement s_WebhooksDeliveriesGetToManyRelationshipSecurityRequirement0 =
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement[] s_WebhooksDeliveriesGetToManyRelationshipSecurityRequirements =
            new global::AppStoreConnect.EndPointSecurityRequirement[]
            {                s_WebhooksDeliveriesGetToManyRelationshipSecurityRequirement0,
            };
        partial void PrepareWebhooksDeliveriesGetToManyRelationshipArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? limit,
            ref string id);
        partial void PrepareWebhooksDeliveriesGetToManyRelationshipRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? limit,
            string id);
        partial void ProcessWebhooksDeliveriesGetToManyRelationshipResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessWebhooksDeliveriesGetToManyRelationshipResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.WebhookDeliveriesLinkagesResponse> WebhooksDeliveriesGetToManyRelationshipAsync(
            string id,
            int? limit = default,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await WebhooksDeliveriesGetToManyRelationshipAsResponseAsync(
                id: id,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AppStoreConnect.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.WebhookDeliveriesLinkagesResponse>> WebhooksDeliveriesGetToManyRelationshipAsResponseAsync(
            string id,
            int? limit = default,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareWebhooksDeliveriesGetToManyRelationshipArguments(
            ...
            var __authorizations = global::AppStoreConnect.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WebhooksDeliveriesGetToManyRelationshipSecurityRequirements,
                operationName: "WebhooksDeliveriesGetToManyRelationshipAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareWebhooksDeliveriesGetToManyRelationshipRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AppStoreConnect.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WebhooksDeliveriesGetToManyRelationship",
                                methodName: "WebhooksDeliveriesGetToManyRelationshipAsync",
                                pathTemplate: "$\"/v1/webhooks/{id}/relationships/deliveries\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWebhooksDeliveriesGetToManyRelationshipResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWebhooksDeliveriesGetToManyRelationshipResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::AppStoreConnect.WebhookDeliveriesLinkagesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.WebhookDeliveriesLinkagesResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::AppStoreConnect.WebhookDeliveriesLinkagesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        /// <summary>
        /// Wraps WebhooksDeliveriesGetToManyRelationshipAsync as an IAsyncEnumerable&lt;global::AppStoreConnect.WebhookDeliveriesLinkagesResponseDataItem&gt; that follows the response's next-page URL.
        /// </summary>
        /// <param name="limit"></param>
        /// <param name="id"></param>
        /// <param name="requestOptions">Options forwarded to every page request.</param>
        /// <param name="cancellationToken"></param>
        public global::System.Collections.Generic.IAsyncEnumerable<global::AppStoreConnect.WebhookDeliveriesLinkagesResponseDataItem> WebhooksDeliveriesGetToManyRelationshipAutoPagingAsync(
            string id,             int? limit = default,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::AppStoreConnect.AutoSDKPager.NextUrlAsync<global::AppStoreConnect.WebhookDeliveriesLinkagesResponse, global::AppStoreConnect.WebhookDeliveriesLinkagesResponseDataItem>(
                fetchPage: (__nextUrl, __ct) => WebhooksDeliveriesGetToManyRelationshipAsync(
                    limit: limit,
                    id: id,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::AppStoreConnect.WebhookDeliveriesLinkagesResponseDataItem>?)__response.Data,
