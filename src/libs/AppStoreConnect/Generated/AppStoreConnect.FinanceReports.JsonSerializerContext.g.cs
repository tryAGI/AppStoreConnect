...
namespace AppStoreConnect
{
    ...
    public sealed partial class FinanceReportsSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static FinanceReportsSourceGenerationContext Default { get; } = new(DefaultOptions);

        private FinanceReportsSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
