...
namespace AppStoreConnect
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::AppStoreConnect.AutoSDKRetryOptions Retry { get; set; } = new global::AppStoreConnect.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::AppStoreConnect.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::AppStoreConnect.IAutoSDKHook>();
        ...
        public global::AppStoreConnect.AutoSDKClientOptions AddHook(
            global::AppStoreConnect.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::AppStoreConnect.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::AppStoreConnect.AutoSDKClientOptions UseAuthorizationProvider(
            global::AppStoreConnect.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::AppStoreConnect.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::AppStoreConnect.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::AppStoreConnect.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::AppStoreConnect.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::AppStoreConnect.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::AppStoreConnect.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::AppStoreConnect.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::AppStoreConnect.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::AppStoreConnect.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::AppStoreConnect.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::AppStoreConnect.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::AppStoreConnect.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::AppStoreConnect.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::AppStoreConnect.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::AppStoreConnect.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::AppStoreConnect.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::AppStoreConnect.AutoSDKClientOptions clientOptions,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::AppStoreConnect.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::AppStoreConnect.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::AppStoreConnect.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::AppStoreConnect.AutoSDKClientOptions clientOptions,
            global::System.Func<global::AppStoreConnect.IAutoSDKHook, global::AppStoreConnect.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::AppStoreConnect.AutoSDKHookContext context)
        {
