...
{
    public partial class BuildUploadsClient
    {


        private static readonly global::AppStoreConnect.EndPointSecurityRequirement s_BuildUploadsBuildUploadFilesGetToManyRelatedSecurityRequirement0 =
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement[] s_BuildUploadsBuildUploadFilesGetToManyRelatedSecurityRequirements =
            new global::AppStoreConnect.EndPointSecurityRequirement[]
            {                s_BuildUploadsBuildUploadFilesGetToManyRelatedSecurityRequirement0,
            };
        partial void PrepareBuildUploadsBuildUploadFilesGetToManyRelatedArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Collections.Generic.IList<global::AppStoreConnect.BuildUploadsBuildUploadFilesGetToManyRelatedFieldsBuildUploadFile>? fieldsBuildUploadFiles,
            ref int? limit,
            ref string id);
        partial void PrepareBuildUploadsBuildUploadFilesGetToManyRelatedRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Collections.Generic.IList<global::AppStoreConnect.BuildUploadsBuildUploadFilesGetToManyRelatedFieldsBuildUploadFile>? fieldsBuildUploadFiles,
            int? limit,
            string id);
        partial void ProcessBuildUploadsBuildUploadFilesGetToManyRelatedResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBuildUploadsBuildUploadFilesGetToManyRelatedResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.BuildUploadFilesResponse> BuildUploadsBuildUploadFilesGetToManyRelatedAsync(
            string id,
        ...
        {
            var __response = await BuildUploadsBuildUploadFilesGetToManyRelatedAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AppStoreConnect.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.BuildUploadFilesResponse>> BuildUploadsBuildUploadFilesGetToManyRelatedAsResponseAsync(
            string id,
            global::System.Collections.Generic.IList<global::AppStoreConnect.BuildUploadsBuildUploadFilesGetToManyRelatedFieldsBuildUploadFile>? fieldsBuildUploadFiles = default,
            int? limit = default,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareBuildUploadsBuildUploadFilesGetToManyRelatedArguments(
            ...
            var __authorizations = global::AppStoreConnect.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_BuildUploadsBuildUploadFilesGetToManyRelatedSecurityRequirements,
                operationName: "BuildUploadsBuildUploadFilesGetToManyRelatedAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBuildUploadsBuildUploadFilesGetToManyRelatedRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AppStoreConnect.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BuildUploadsBuildUploadFilesGetToManyRelated",
                                methodName: "BuildUploadsBuildUploadFilesGetToManyRelatedAsync",
                                pathTemplate: "$\"/v1/buildUploads/{id}/buildUploadFiles\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBuildUploadsBuildUploadFilesGetToManyRelatedResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBuildUploadsBuildUploadFilesGetToManyRelatedResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::AppStoreConnect.BuildUploadFilesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.BuildUploadFilesResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::AppStoreConnect.BuildUploadFilesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        /// <summary>
        /// Wraps BuildUploadsBuildUploadFilesGetToManyRelatedAsync as an IAsyncEnumerable&lt;global::AppStoreConnect.BuildUploadFile&gt; that follows the response's next-page URL.
        /// </summary>
        /// <param name="fieldsBuildUploadFiles"></param>
        /// <param name="limit"></param>
        /// <param name="id"></param>
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::AppStoreConnect.BuildUploadFile> BuildUploadsBuildUploadFilesGetToManyRelatedAutoPagingAsync(
            string id,             global::System.Collections.Generic.IList<global::AppStoreConnect.BuildUploadsBuildUploadFilesGetToManyRelatedFieldsBuildUploadFile>? fieldsBuildUploadFiles = default,
            int? limit = default,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::AppStoreConnect.AutoSDKPager.NextUrlAsync<global::AppStoreConnect.BuildUploadFilesResponse, global::AppStoreConnect.BuildUploadFile>(
                fetchPage: (__nextUrl, __ct) => BuildUploadsBuildUploadFilesGetToManyRelatedAsync(
                    fieldsBuildUploadFiles: fieldsBuildUploadFiles,
                    limit: limit,
                    id: id,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::AppStoreConnect.BuildUploadFile>?)__response.Data,
