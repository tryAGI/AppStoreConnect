...
namespace AppStoreConnect
{
    public partial class BackgroundAssetsClient
    {
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement s_BackgroundAssetsCreateInstanceSecurityRequirement0 =
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement[] s_BackgroundAssetsCreateInstanceSecurityRequirements =
            new global::AppStoreConnect.EndPointSecurityRequirement[]
            {                s_BackgroundAssetsCreateInstanceSecurityRequirement0,
            };
        partial void PrepareBackgroundAssetsCreateInstanceArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::AppStoreConnect.BackgroundAssetCreateRequest request);
        partial void PrepareBackgroundAssetsCreateInstanceRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::AppStoreConnect.BackgroundAssetCreateRequest request);
        partial void ProcessBackgroundAssetsCreateInstanceResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBackgroundAssetsCreateInstanceResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.BackgroundAssetResponse> BackgroundAssetsCreateInstanceAsync(

            global::AppStoreConnect.BackgroundAssetCreateRequest request,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await BackgroundAssetsCreateInstanceAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AppStoreConnect.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.BackgroundAssetResponse>> BackgroundAssetsCreateInstanceAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareBackgroundAssetsCreateInstanceArguments(
            ...
            var __authorizations = global::AppStoreConnect.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_BackgroundAssetsCreateInstanceSecurityRequirements,
                operationName: "BackgroundAssetsCreateInstanceAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBackgroundAssetsCreateInstanceRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AppStoreConnect.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BackgroundAssetsCreateInstance",
                                methodName: "BackgroundAssetsCreateInstanceAsync",
                                pathTemplate: "\"/v1/backgroundAssets\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBackgroundAssetsCreateInstanceResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBackgroundAssetsCreateInstanceResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.BackgroundAssetResponse> BackgroundAssetsCreateInstanceAsync(
            global::AppStoreConnect.BackgroundAssetCreateRequestData data,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::AppStoreConnect.BackgroundAssetCreateRequest
            {
                Data = data,
            };

            return await BackgroundAssetsCreateInstanceAsync(
                request: __request,
                requestOptions: requestOptions,
