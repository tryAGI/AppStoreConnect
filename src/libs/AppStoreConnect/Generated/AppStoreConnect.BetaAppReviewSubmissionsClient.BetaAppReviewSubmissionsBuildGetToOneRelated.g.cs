...
namespace AppStoreConnect
{
    public partial class BetaAppReviewSubmissionsClient
    {
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement s_BetaAppReviewSubmissionsBuildGetToOneRelatedSecurityRequirement0 =
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement[] s_BetaAppReviewSubmissionsBuildGetToOneRelatedSecurityRequirements =
            new global::AppStoreConnect.EndPointSecurityRequirement[]
            {                s_BetaAppReviewSubmissionsBuildGetToOneRelatedSecurityRequirement0,
            };
        partial void PrepareBetaAppReviewSubmissionsBuildGetToOneRelatedArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Collections.Generic.IList<global::AppStoreConnect.BetaAppReviewSubmissionsBuildGetToOneRelatedFieldsBuild>? fieldsBuilds,
            ref string id);
        partial void PrepareBetaAppReviewSubmissionsBuildGetToOneRelatedRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Collections.Generic.IList<global::AppStoreConnect.BetaAppReviewSubmissionsBuildGetToOneRelatedFieldsBuild>? fieldsBuilds,
            string id);
        partial void ProcessBetaAppReviewSubmissionsBuildGetToOneRelatedResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaAppReviewSubmissionsBuildGetToOneRelatedResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.BuildWithoutIncludesResponse> BetaAppReviewSubmissionsBuildGetToOneRelatedAsync(
            string id,
            global::System.Collections.Generic.IList<global::AppStoreConnect.BetaAppReviewSubmissionsBuildGetToOneRelatedFieldsBuild>? fieldsBuilds = default,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await BetaAppReviewSubmissionsBuildGetToOneRelatedAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AppStoreConnect.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.BuildWithoutIncludesResponse>> BetaAppReviewSubmissionsBuildGetToOneRelatedAsResponseAsync(
            string id,
            global::System.Collections.Generic.IList<global::AppStoreConnect.BetaAppReviewSubmissionsBuildGetToOneRelatedFieldsBuild>? fieldsBuilds = default,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareBetaAppReviewSubmissionsBuildGetToOneRelatedArguments(
            ...
            var __authorizations = global::AppStoreConnect.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_BetaAppReviewSubmissionsBuildGetToOneRelatedSecurityRequirements,
                operationName: "BetaAppReviewSubmissionsBuildGetToOneRelatedAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaAppReviewSubmissionsBuildGetToOneRelatedRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AppStoreConnect.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "BetaAppReviewSubmissionsBuildGetToOneRelatedAsync",
                                pathTemplate: "$\"/v1/betaAppReviewSubmissions/{id}/build\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaAppReviewSubmissionsBuildGetToOneRelatedResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaAppReviewSubmissionsBuildGetToOneRelatedResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::AppStoreConnect.BuildWithoutIncludesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.BuildWithoutIncludesResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::AppStoreConnect.BuildWithoutIncludesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
