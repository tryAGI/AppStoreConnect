...
namespace AppStoreConnect
{
    public partial class CiBuildActionsClient
    {
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement s_CiBuildActionsTestResultsGetToManyRelatedSecurityRequirement0 =
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement[] s_CiBuildActionsTestResultsGetToManyRelatedSecurityRequirements =
            new global::AppStoreConnect.EndPointSecurityRequirement[]
            {                s_CiBuildActionsTestResultsGetToManyRelatedSecurityRequirement0,
            };
        partial void PrepareCiBuildActionsTestResultsGetToManyRelatedArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Collections.Generic.IList<global::AppStoreConnect.CiBuildActionsTestResultsGetToManyRelatedFieldsCiTestResult>? fieldsCiTestResults,
            ref int? limit,
            ref string id);
        partial void PrepareCiBuildActionsTestResultsGetToManyRelatedRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Collections.Generic.IList<global::AppStoreConnect.CiBuildActionsTestResultsGetToManyRelatedFieldsCiTestResult>? fieldsCiTestResults,
            int? limit,
            string id);
        partial void ProcessCiBuildActionsTestResultsGetToManyRelatedResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCiBuildActionsTestResultsGetToManyRelatedResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.CiTestResultsResponse> CiBuildActionsTestResultsGetToManyRelatedAsync(
            string id,
        ...
        {
            var __response = await CiBuildActionsTestResultsGetToManyRelatedAsResponseAsync(
                id: id,
                fieldsCiTestResults: fieldsCiTestResults,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AppStoreConnect.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.CiTestResultsResponse>> CiBuildActionsTestResultsGetToManyRelatedAsResponseAsync(
            string id,
            global::System.Collections.Generic.IList<global::AppStoreConnect.CiBuildActionsTestResultsGetToManyRelatedFieldsCiTestResult>? fieldsCiTestResults = default,
            int? limit = default,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCiBuildActionsTestResultsGetToManyRelatedArguments(
            ...
            var __authorizations = global::AppStoreConnect.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CiBuildActionsTestResultsGetToManyRelatedSecurityRequirements,
                operationName: "CiBuildActionsTestResultsGetToManyRelatedAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                .AddOptionalParameter("fields[ciTestResults]", fieldsCiTestResults, selector: static x => x.ToValueString(), delimiter: ",", explode: false)
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCiBuildActionsTestResultsGetToManyRelatedRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AppStoreConnect.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CiBuildActionsTestResultsGetToManyRelated",
                                methodName: "CiBuildActionsTestResultsGetToManyRelatedAsync",
                                pathTemplate: "$\"/v1/ciBuildActions/{id}/testResults\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCiBuildActionsTestResultsGetToManyRelatedResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCiBuildActionsTestResultsGetToManyRelatedResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::AppStoreConnect.CiTestResultsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.CiTestResultsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::AppStoreConnect.CiTestResultsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::AppStoreConnect.CiTestResult> CiBuildActionsTestResultsGetToManyRelatedAutoPagingAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::AppStoreConnect.AutoSDKPager.NextUrlAsync<global::AppStoreConnect.CiTestResultsResponse, global::AppStoreConnect.CiTestResult>(
                fetchPage: (__nextUrl, __ct) => CiBuildActionsTestResultsGetToManyRelatedAsync(
                    fieldsCiTestResults: fieldsCiTestResults,
                    limit: limit,
                    id: id,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::AppStoreConnect.CiTestResult>?)__response.Data,
