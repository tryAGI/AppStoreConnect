...
{
    public partial class AppEventVideoClipsClient
    {


        private static readonly global::AppStoreConnect.EndPointSecurityRequirement s_AppEventVideoClipsUpdateInstanceSecurityRequirement0 =
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement[] s_AppEventVideoClipsUpdateInstanceSecurityRequirements =
            new global::AppStoreConnect.EndPointSecurityRequirement[]
            {                s_AppEventVideoClipsUpdateInstanceSecurityRequirement0,
            };
        partial void PrepareAppEventVideoClipsUpdateInstanceArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            global::AppStoreConnect.AppEventVideoClipUpdateRequest request);
        partial void PrepareAppEventVideoClipsUpdateInstanceRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::AppStoreConnect.AppEventVideoClipUpdateRequest request);
        partial void ProcessAppEventVideoClipsUpdateInstanceResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAppEventVideoClipsUpdateInstanceResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AppEventVideoClipResponse> AppEventVideoClipsUpdateInstanceAsync(
            string id,
        ...
        {
            var __response = await AppEventVideoClipsUpdateInstanceAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AppStoreConnect.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.AppEventVideoClipResponse>> AppEventVideoClipsUpdateInstanceAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAppEventVideoClipsUpdateInstanceArguments(
            ...
            var __authorizations = global::AppStoreConnect.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AppEventVideoClipsUpdateInstanceSecurityRequirements,
                operationName: "AppEventVideoClipsUpdateInstanceAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAppEventVideoClipsUpdateInstanceRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AppStoreConnect.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AppEventVideoClipsUpdateInstance",
                                methodName: "AppEventVideoClipsUpdateInstanceAsync",
                                pathTemplate: "$\"/v1/appEventVideoClips/{id}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAppEventVideoClipsUpdateInstanceResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAppEventVideoClipsUpdateInstanceResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::AppStoreConnect.AppEventVideoClipResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.AppEventVideoClipResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::AppStoreConnect.AppEventVideoClipResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AppEventVideoClipResponse> AppEventVideoClipsUpdateInstanceAsync(
            string id,
            global::AppStoreConnect.AppEventVideoClipUpdateRequestData data,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::AppStoreConnect.AppEventVideoClipUpdateRequest
            {
                Data = data,
            };

            return await AppEventVideoClipsUpdateInstanceAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
