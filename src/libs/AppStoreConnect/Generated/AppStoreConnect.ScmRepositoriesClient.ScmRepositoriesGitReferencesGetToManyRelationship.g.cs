...
namespace AppStoreConnect
{
    public partial class ScmRepositoriesClient
    {
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement s_ScmRepositoriesGitReferencesGetToManyRelationshipSecurityRequirement0 =
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement[] s_ScmRepositoriesGitReferencesGetToManyRelationshipSecurityRequirements =
            new global::AppStoreConnect.EndPointSecurityRequirement[]
            {                s_ScmRepositoriesGitReferencesGetToManyRelationshipSecurityRequirement0,
            };
        partial void PrepareScmRepositoriesGitReferencesGetToManyRelationshipArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? limit,
            ref string id);
        partial void PrepareScmRepositoriesGitReferencesGetToManyRelationshipRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? limit,
            string id);
        partial void ProcessScmRepositoriesGitReferencesGetToManyRelationshipResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessScmRepositoriesGitReferencesGetToManyRelationshipResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.ScmRepositoryGitReferencesLinkagesResponse> ScmRepositoriesGitReferencesGetToManyRelationshipAsync(
            string id,
            int? limit = default,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ScmRepositoriesGitReferencesGetToManyRelationshipAsResponseAsync(
                id: id,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AppStoreConnect.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.ScmRepositoryGitReferencesLinkagesResponse>> ScmRepositoriesGitReferencesGetToManyRelationshipAsResponseAsync(
            string id,
            int? limit = default,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareScmRepositoriesGitReferencesGetToManyRelationshipArguments(
            ...
            var __authorizations = global::AppStoreConnect.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ScmRepositoriesGitReferencesGetToManyRelationshipSecurityRequirements,
                operationName: "ScmRepositoriesGitReferencesGetToManyRelationshipAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareScmRepositoriesGitReferencesGetToManyRelationshipRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AppStoreConnect.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ScmRepositoriesGitReferencesGetToManyRelationship",
                                methodName: "ScmRepositoriesGitReferencesGetToManyRelationshipAsync",
                                pathTemplate: "$\"/v1/scmRepositories/{id}/relationships/gitReferences\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessScmRepositoriesGitReferencesGetToManyRelationshipResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessScmRepositoriesGitReferencesGetToManyRelationshipResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::AppStoreConnect.ScmRepositoryGitReferencesLinkagesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.ScmRepositoryGitReferencesLinkagesResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::AppStoreConnect.ScmRepositoryGitReferencesLinkagesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        /// <summary>
        /// Wraps ScmRepositoriesGitReferencesGetToManyRelationshipAsync as an IAsyncEnumerable&lt;global::AppStoreConnect.ScmRepositoryGitReferencesLinkagesResponseDataItem&gt; that follows the response's next-page URL.
        /// </summary>
        /// <param name="limit"></param>
        /// <param name="id"></param>
        /// <param name="requestOptions">Options forwarded to every page request.</param>
        /// <param name="cancellationToken"></param>
        public global::System.Collections.Generic.IAsyncEnumerable<global::AppStoreConnect.ScmRepositoryGitReferencesLinkagesResponseDataItem> ScmRepositoriesGitReferencesGetToManyRelationshipAutoPagingAsync(
            string id,             int? limit = default,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::AppStoreConnect.AutoSDKPager.NextUrlAsync<global::AppStoreConnect.ScmRepositoryGitReferencesLinkagesResponse, global::AppStoreConnect.ScmRepositoryGitReferencesLinkagesResponseDataItem>(
                fetchPage: (__nextUrl, __ct) => ScmRepositoriesGitReferencesGetToManyRelationshipAsync(
                    limit: limit,
                    id: id,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::AppStoreConnect.ScmRepositoryGitReferencesLinkagesResponseDataItem>?)__response.Data,
