...
namespace AppStoreConnect
{
    public partial class SubscriptionPricePointsClient
    {
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement s_SubscriptionPricePointsAdjustedEqualizationsGetToManyRelatedSecurityRequirement0 =
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement[] s_SubscriptionPricePointsAdjustedEqualizationsGetToManyRelatedSecurityRequirements =
            new global::AppStoreConnect.EndPointSecurityRequirement[]
            {                s_SubscriptionPricePointsAdjustedEqualizationsGetToManyRelatedSecurityRequirement0,
            };
        partial void PrepareSubscriptionPricePointsAdjustedEqualizationsGetToManyRelatedArguments(
            ...
            ref string id);
        partial void PrepareSubscriptionPricePointsAdjustedEqualizationsGetToManyRelatedRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::System.Collections.Generic.IList<global::AppStoreConnect.SubscriptionPricePointsAdjustedEqualizationsGetToManyRelatedIncludeItem>? include,
            string id);
        partial void ProcessSubscriptionPricePointsAdjustedEqualizationsGetToManyRelatedResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSubscriptionPricePointsAdjustedEqualizationsGetToManyRelatedResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareSubscriptionPricePointsAdjustedEqualizationsGetToManyRelatedArguments(
            ...
            var __authorizations = global::AppStoreConnect.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SubscriptionPricePointsAdjustedEqualizationsGetToManyRelatedSecurityRequirements,
                operationName: "SubscriptionPricePointsAdjustedEqualizationsGetToManyRelatedAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSubscriptionPricePointsAdjustedEqualizationsGetToManyRelatedRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AppStoreConnect.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SubscriptionPricePointsAdjustedEqualizationsGetToManyRelated",
                                methodName: "SubscriptionPricePointsAdjustedEqualizationsGetToManyRelatedAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSubscriptionPricePointsAdjustedEqualizationsGetToManyRelatedResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSubscriptionPricePointsAdjustedEqualizationsGetToManyRelatedResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
