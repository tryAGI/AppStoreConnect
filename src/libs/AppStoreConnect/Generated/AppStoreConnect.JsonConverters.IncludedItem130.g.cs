...
{
    /// <inheritdoc />
    public class IncludedItem130JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::AppStoreConnect.IncludedItem130>
    {
        /// <inheritdoc />
        public override global::AppStoreConnect.IncludedItem130 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::AppStoreConnect.GameCenterLeaderboardsV2ResponseIncludedItemDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::AppStoreConnect.GameCenterLeaderboardsV2ResponseIncludedItemDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::AppStoreConnect.GameCenterLeaderboardsV2ResponseIncludedItemDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::AppStoreConnect.GameCenterActivity? gameCenterActivities = default;
            if (discriminator?.Type == global::AppStoreConnect.GameCenterLeaderboardsV2ResponseIncludedItemDiscriminatorType.GameCenterActivities)
            {
            ...
            if (discriminator?.Type == global::AppStoreConnect.GameCenterLeaderboardsV2ResponseIncludedItemDiscriminatorType.GameCenterChallenges)
            {
            ...
            if (discriminator?.Type == global::AppStoreConnect.GameCenterLeaderboardsV2ResponseIncludedItemDiscriminatorType.GameCenterDetails)
            {
            ...
            if (discriminator?.Type == global::AppStoreConnect.GameCenterLeaderboardsV2ResponseIncludedItemDiscriminatorType.GameCenterGroups)
            {
            ...
            if (discriminator?.Type == global::AppStoreConnect.GameCenterLeaderboardsV2ResponseIncludedItemDiscriminatorType.GameCenterLeaderboardSets)
            {
            ...
            if (discriminator?.Type == global::AppStoreConnect.GameCenterLeaderboardsV2ResponseIncludedItemDiscriminatorType.GameCenterLeaderboardVersions)
            {
            ...
            var __value = new global::AppStoreConnect.IncludedItem130(
                discriminator?.Type,
        ...
        public override void Write(
            ...
            global::AppStoreConnect.IncludedItem130 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
