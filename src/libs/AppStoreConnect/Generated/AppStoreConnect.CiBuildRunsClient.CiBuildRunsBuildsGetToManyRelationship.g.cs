...
namespace AppStoreConnect
{
    public partial class CiBuildRunsClient
    {
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement s_CiBuildRunsBuildsGetToManyRelationshipSecurityRequirement0 =
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement[] s_CiBuildRunsBuildsGetToManyRelationshipSecurityRequirements =
            new global::AppStoreConnect.EndPointSecurityRequirement[]
            {                s_CiBuildRunsBuildsGetToManyRelationshipSecurityRequirement0,
            };
        partial void PrepareCiBuildRunsBuildsGetToManyRelationshipArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? limit,
            ref string id);
        partial void PrepareCiBuildRunsBuildsGetToManyRelationshipRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? limit,
            string id);
        partial void ProcessCiBuildRunsBuildsGetToManyRelationshipResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCiBuildRunsBuildsGetToManyRelationshipResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.CiBuildRunBuildsLinkagesResponse> CiBuildRunsBuildsGetToManyRelationshipAsync(
            string id,
            int? limit = default,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CiBuildRunsBuildsGetToManyRelationshipAsResponseAsync(
                id: id,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AppStoreConnect.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.CiBuildRunBuildsLinkagesResponse>> CiBuildRunsBuildsGetToManyRelationshipAsResponseAsync(
            string id,
            int? limit = default,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCiBuildRunsBuildsGetToManyRelationshipArguments(
            ...
            var __authorizations = global::AppStoreConnect.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CiBuildRunsBuildsGetToManyRelationshipSecurityRequirements,
                operationName: "CiBuildRunsBuildsGetToManyRelationshipAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCiBuildRunsBuildsGetToManyRelationshipRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AppStoreConnect.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CiBuildRunsBuildsGetToManyRelationship",
                                methodName: "CiBuildRunsBuildsGetToManyRelationshipAsync",
                                pathTemplate: "$\"/v1/ciBuildRuns/{id}/relationships/builds\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCiBuildRunsBuildsGetToManyRelationshipResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCiBuildRunsBuildsGetToManyRelationshipResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::AppStoreConnect.CiBuildRunBuildsLinkagesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.CiBuildRunBuildsLinkagesResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::AppStoreConnect.CiBuildRunBuildsLinkagesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        /// <summary>
        /// Wraps CiBuildRunsBuildsGetToManyRelationshipAsync as an IAsyncEnumerable&lt;global::AppStoreConnect.CiBuildRunBuildsLinkagesResponseDataItem&gt; that follows the response's next-page URL.
        /// </summary>
        /// <param name="limit"></param>
        /// <param name="id"></param>
        /// <param name="requestOptions">Options forwarded to every page request.</param>
        /// <param name="cancellationToken"></param>
        public global::System.Collections.Generic.IAsyncEnumerable<global::AppStoreConnect.CiBuildRunBuildsLinkagesResponseDataItem> CiBuildRunsBuildsGetToManyRelationshipAutoPagingAsync(
            string id,             int? limit = default,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::AppStoreConnect.AutoSDKPager.NextUrlAsync<global::AppStoreConnect.CiBuildRunBuildsLinkagesResponse, global::AppStoreConnect.CiBuildRunBuildsLinkagesResponseDataItem>(
                fetchPage: (__nextUrl, __ct) => CiBuildRunsBuildsGetToManyRelationshipAsync(
                    limit: limit,
                    id: id,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::AppStoreConnect.CiBuildRunBuildsLinkagesResponseDataItem>?)__response.Data,
