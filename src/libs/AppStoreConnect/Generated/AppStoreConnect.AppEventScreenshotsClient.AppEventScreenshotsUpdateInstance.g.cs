...
{
    public partial class AppEventScreenshotsClient
    {


        private static readonly global::AppStoreConnect.EndPointSecurityRequirement s_AppEventScreenshotsUpdateInstanceSecurityRequirement0 =
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement[] s_AppEventScreenshotsUpdateInstanceSecurityRequirements =
            new global::AppStoreConnect.EndPointSecurityRequirement[]
            {                s_AppEventScreenshotsUpdateInstanceSecurityRequirement0,
            };
        partial void PrepareAppEventScreenshotsUpdateInstanceArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            global::AppStoreConnect.AppEventScreenshotUpdateRequest request);
        partial void PrepareAppEventScreenshotsUpdateInstanceRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::AppStoreConnect.AppEventScreenshotUpdateRequest request);
        partial void ProcessAppEventScreenshotsUpdateInstanceResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAppEventScreenshotsUpdateInstanceResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AppEventScreenshotResponse> AppEventScreenshotsUpdateInstanceAsync(
            string id,
        ...
        {
            var __response = await AppEventScreenshotsUpdateInstanceAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AppStoreConnect.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.AppEventScreenshotResponse>> AppEventScreenshotsUpdateInstanceAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAppEventScreenshotsUpdateInstanceArguments(
            ...
            var __authorizations = global::AppStoreConnect.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AppEventScreenshotsUpdateInstanceSecurityRequirements,
                operationName: "AppEventScreenshotsUpdateInstanceAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAppEventScreenshotsUpdateInstanceRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AppStoreConnect.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AppEventScreenshotsUpdateInstance",
                                methodName: "AppEventScreenshotsUpdateInstanceAsync",
                                pathTemplate: "$\"/v1/appEventScreenshots/{id}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAppEventScreenshotsUpdateInstanceResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAppEventScreenshotsUpdateInstanceResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::AppStoreConnect.AppEventScreenshotResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.AppEventScreenshotResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::AppStoreConnect.AppEventScreenshotResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AppEventScreenshotResponse> AppEventScreenshotsUpdateInstanceAsync(
            string id,
            global::AppStoreConnect.AppEventScreenshotUpdateRequestData data,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::AppStoreConnect.AppEventScreenshotUpdateRequest
            {
                Data = data,
            };

            return await AppEventScreenshotsUpdateInstanceAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
