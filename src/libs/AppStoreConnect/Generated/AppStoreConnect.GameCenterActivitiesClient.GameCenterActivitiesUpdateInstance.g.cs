...
namespace AppStoreConnect
{
    public partial class GameCenterActivitiesClient
    {
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement s_GameCenterActivitiesUpdateInstanceSecurityRequirement0 =
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement[] s_GameCenterActivitiesUpdateInstanceSecurityRequirements =
            new global::AppStoreConnect.EndPointSecurityRequirement[]
            {                s_GameCenterActivitiesUpdateInstanceSecurityRequirement0,
            };
        partial void PrepareGameCenterActivitiesUpdateInstanceArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            global::AppStoreConnect.GameCenterActivityUpdateRequest request);
        partial void PrepareGameCenterActivitiesUpdateInstanceRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::AppStoreConnect.GameCenterActivityUpdateRequest request);
        partial void ProcessGameCenterActivitiesUpdateInstanceResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGameCenterActivitiesUpdateInstanceResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.GameCenterActivityResponse> GameCenterActivitiesUpdateInstanceAsync(
            string id,
        ...
        {
            var __response = await GameCenterActivitiesUpdateInstanceAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AppStoreConnect.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.GameCenterActivityResponse>> GameCenterActivitiesUpdateInstanceAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGameCenterActivitiesUpdateInstanceArguments(
            ...
            var __authorizations = global::AppStoreConnect.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GameCenterActivitiesUpdateInstanceSecurityRequirements,
                operationName: "GameCenterActivitiesUpdateInstanceAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGameCenterActivitiesUpdateInstanceRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AppStoreConnect.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GameCenterActivitiesUpdateInstance",
                                methodName: "GameCenterActivitiesUpdateInstanceAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGameCenterActivitiesUpdateInstanceResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGameCenterActivitiesUpdateInstanceResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.GameCenterActivityResponse> GameCenterActivitiesUpdateInstanceAsync(
            string id,
            global::AppStoreConnect.GameCenterActivityUpdateRequestData data,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::AppStoreConnect.GameCenterActivityUpdateRequest
            {
                Data = data,
            };

            return await GameCenterActivitiesUpdateInstanceAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
