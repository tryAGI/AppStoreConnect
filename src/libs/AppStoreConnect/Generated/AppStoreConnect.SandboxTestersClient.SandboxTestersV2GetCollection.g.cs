...
{
    public partial class SandboxTestersClient
    {


        private static readonly global::AppStoreConnect.EndPointSecurityRequirement s_SandboxTestersV2GetCollectionSecurityRequirement0 =
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement[] s_SandboxTestersV2GetCollectionSecurityRequirements =
            new global::AppStoreConnect.EndPointSecurityRequirement[]
            {                s_SandboxTestersV2GetCollectionSecurityRequirement0,
            };
        partial void PrepareSandboxTestersV2GetCollectionArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Collections.Generic.IList<global::AppStoreConnect.SandboxTestersV2GetCollectionFieldsSandboxTester>? fieldsSandboxTesters,
            ref int? limit);
        partial void PrepareSandboxTestersV2GetCollectionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Collections.Generic.IList<global::AppStoreConnect.SandboxTestersV2GetCollectionFieldsSandboxTester>? fieldsSandboxTesters,
            int? limit);
        partial void ProcessSandboxTestersV2GetCollectionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSandboxTestersV2GetCollectionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.SandboxTestersV2Response> SandboxTestersV2GetCollectionAsync(
        ...
        {
            var __response = await SandboxTestersV2GetCollectionAsResponseAsync(
                fieldsSandboxTesters: fieldsSandboxTesters,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AppStoreConnect.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.SandboxTestersV2Response>> SandboxTestersV2GetCollectionAsResponseAsync(
            global::System.Collections.Generic.IList<global::AppStoreConnect.SandboxTestersV2GetCollectionFieldsSandboxTester>? fieldsSandboxTesters = default,
            int? limit = default,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareSandboxTestersV2GetCollectionArguments(
            ...
            var __authorizations = global::AppStoreConnect.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SandboxTestersV2GetCollectionSecurityRequirements,
                operationName: "SandboxTestersV2GetCollectionAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                .AddOptionalParameter("fields[sandboxTesters]", fieldsSandboxTesters, selector: static x => x.ToValueString(), delimiter: ",", explode: false)
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSandboxTestersV2GetCollectionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AppStoreConnect.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SandboxTestersV2GetCollection",
                                methodName: "SandboxTestersV2GetCollectionAsync",
                                pathTemplate: "\"/v2/sandboxTesters\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSandboxTestersV2GetCollectionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSandboxTestersV2GetCollectionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::AppStoreConnect.SandboxTestersV2Response.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.SandboxTestersV2Response>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::AppStoreConnect.SandboxTestersV2Response.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::AppStoreConnect.SandboxTesterV2> SandboxTestersV2GetCollectionAutoPagingAsync(
              global::System.Collections.Generic.IList<global::AppStoreConnect.SandboxTestersV2GetCollectionFieldsSandboxTester>? fieldsSandboxTesters = default,
            int? limit = default,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::AppStoreConnect.AutoSDKPager.NextUrlAsync<global::AppStoreConnect.SandboxTestersV2Response, global::AppStoreConnect.SandboxTesterV2>(
                fetchPage: (__nextUrl, __ct) => SandboxTestersV2GetCollectionAsync(
                    fieldsSandboxTesters: fieldsSandboxTesters,
                    limit: limit,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::AppStoreConnect.SandboxTesterV2>?)__response.Data,
