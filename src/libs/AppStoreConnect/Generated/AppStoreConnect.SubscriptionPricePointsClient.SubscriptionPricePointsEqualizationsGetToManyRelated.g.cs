...
namespace AppStoreConnect
{
    public partial class SubscriptionPricePointsClient
    {
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement s_SubscriptionPricePointsEqualizationsGetToManyRelatedSecurityRequirement0 =
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement[] s_SubscriptionPricePointsEqualizationsGetToManyRelatedSecurityRequirements =
            new global::AppStoreConnect.EndPointSecurityRequirement[]
            {                s_SubscriptionPricePointsEqualizationsGetToManyRelatedSecurityRequirement0,
            };
        partial void PrepareSubscriptionPricePointsEqualizationsGetToManyRelatedArguments(
            ...
            global::System.Collections.Generic.IList<global::AppStoreConnect.SubscriptionPricePointsEqualizationsGetToManyRelatedFieldsSubscriptionPricePoint>? fieldsSubscriptionPricePoints,
            global::System.Collections.Generic.IList<global::AppStoreConnect.SubscriptionPricePointsEqualizationsGetToManyRelatedFieldsTerritorie>? fieldsTerritories,
            ref int? limit,
            global::System.Collections.Generic.IList<global::AppStoreConnect.SubscriptionPricePointsEqualizationsGetToManyRelatedIncludeItem>? include,
            ref string id);
        partial void PrepareSubscriptionPricePointsEqualizationsGetToManyRelatedRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::System.Collections.Generic.IList<global::AppStoreConnect.SubscriptionPricePointsEqualizationsGetToManyRelatedIncludeItem>? include,
            string id);
        partial void ProcessSubscriptionPricePointsEqualizationsGetToManyRelatedResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSubscriptionPricePointsEqualizationsGetToManyRelatedResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.SubscriptionPricePointsResponse> SubscriptionPricePointsEqualizationsGetToManyRelatedAsync(
            string id,
        ...
        {
            var __response = await SubscriptionPricePointsEqualizationsGetToManyRelatedAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AppStoreConnect.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.SubscriptionPricePointsResponse>> SubscriptionPricePointsEqualizationsGetToManyRelatedAsResponseAsync(
            string id,
            global::System.Collections.Generic.IList<string>? filterTerritory = default,
            global::System.Collections.Generic.IList<string>? filterSubscription = default,
            global::System.Collections.Generic.IList<string>? filterUpfrontPricePointId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareSubscriptionPricePointsEqualizationsGetToManyRelatedArguments(
            ...
            var __authorizations = global::AppStoreConnect.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SubscriptionPricePointsEqualizationsGetToManyRelatedSecurityRequirements,
                operationName: "SubscriptionPricePointsEqualizationsGetToManyRelatedAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSubscriptionPricePointsEqualizationsGetToManyRelatedRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AppStoreConnect.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SubscriptionPricePointsEqualizationsGetToManyRelated",
                                methodName: "SubscriptionPricePointsEqualizationsGetToManyRelatedAsync",
                                pathTemplate: "$\"/v1/subscriptionPricePoints/{id}/equalizations\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSubscriptionPricePointsEqualizationsGetToManyRelatedResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSubscriptionPricePointsEqualizationsGetToManyRelatedResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::AppStoreConnect.SubscriptionPricePointsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.SubscriptionPricePointsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::AppStoreConnect.SubscriptionPricePointsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
