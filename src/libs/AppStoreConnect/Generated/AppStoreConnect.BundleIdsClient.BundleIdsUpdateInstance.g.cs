...
namespace AppStoreConnect
{
    public partial class BundleIdsClient
    {
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement s_BundleIdsUpdateInstanceSecurityRequirement0 =
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement[] s_BundleIdsUpdateInstanceSecurityRequirements =
            new global::AppStoreConnect.EndPointSecurityRequirement[]
            {                s_BundleIdsUpdateInstanceSecurityRequirement0,
            };
        partial void PrepareBundleIdsUpdateInstanceArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            global::AppStoreConnect.BundleIdUpdateRequest request);
        partial void PrepareBundleIdsUpdateInstanceRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::AppStoreConnect.BundleIdUpdateRequest request);
        partial void ProcessBundleIdsUpdateInstanceResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBundleIdsUpdateInstanceResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.BundleIdResponse> BundleIdsUpdateInstanceAsync(
            string id,
        ...
        {
            var __response = await BundleIdsUpdateInstanceAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AppStoreConnect.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.BundleIdResponse>> BundleIdsUpdateInstanceAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareBundleIdsUpdateInstanceArguments(
            ...
            var __authorizations = global::AppStoreConnect.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_BundleIdsUpdateInstanceSecurityRequirements,
                operationName: "BundleIdsUpdateInstanceAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBundleIdsUpdateInstanceRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AppStoreConnect.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "BundleIdsUpdateInstanceAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBundleIdsUpdateInstanceResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBundleIdsUpdateInstanceResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.BundleIdResponse> BundleIdsUpdateInstanceAsync(
            string id,
            global::AppStoreConnect.BundleIdUpdateRequestData data,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::AppStoreConnect.BundleIdUpdateRequest
            {
                Data = data,
            };

            return await BundleIdsUpdateInstanceAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
