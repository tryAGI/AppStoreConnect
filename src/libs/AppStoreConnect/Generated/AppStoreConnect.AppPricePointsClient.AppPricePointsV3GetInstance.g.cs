...
namespace AppStoreConnect
{
    public partial class AppPricePointsClient
    {
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement s_AppPricePointsV3GetInstanceSecurityRequirement0 =
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement[] s_AppPricePointsV3GetInstanceSecurityRequirements =
            new global::AppStoreConnect.EndPointSecurityRequirement[]
            {                s_AppPricePointsV3GetInstanceSecurityRequirement0,
            };
        partial void PrepareAppPricePointsV3GetInstanceArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Collections.Generic.IList<global::AppStoreConnect.AppPricePointsV3GetInstanceFieldsAppPricePoint>? fieldsAppPricePoints,
            global::System.Collections.Generic.IList<global::AppStoreConnect.AppPricePointsV3GetInstanceFieldsApp>? fieldsApps,
            global::System.Collections.Generic.IList<global::AppStoreConnect.AppPricePointsV3GetInstanceFieldsTerritorie>? fieldsTerritories,
            global::System.Collections.Generic.IList<global::AppStoreConnect.AppPricePointsV3GetInstanceIncludeItem>? include,
            ref string id);
        partial void PrepareAppPricePointsV3GetInstanceRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::System.Collections.Generic.IList<global::AppStoreConnect.AppPricePointsV3GetInstanceIncludeItem>? include,
            string id);
        partial void ProcessAppPricePointsV3GetInstanceResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAppPricePointsV3GetInstanceResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AppPricePointV3Response> AppPricePointsV3GetInstanceAsync(
            string id,
        ...
        {
            var __response = await AppPricePointsV3GetInstanceAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AppStoreConnect.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.AppPricePointV3Response>> AppPricePointsV3GetInstanceAsResponseAsync(
            string id,
            global::System.Collections.Generic.IList<global::AppStoreConnect.AppPricePointsV3GetInstanceFieldsAppPricePoint>? fieldsAppPricePoints = default,
            global::System.Collections.Generic.IList<global::AppStoreConnect.AppPricePointsV3GetInstanceFieldsApp>? fieldsApps = default,
            global::System.Collections.Generic.IList<global::AppStoreConnect.AppPricePointsV3GetInstanceFieldsTerritorie>? fieldsTerritories = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAppPricePointsV3GetInstanceArguments(
            ...
            var __authorizations = global::AppStoreConnect.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AppPricePointsV3GetInstanceSecurityRequirements,
                operationName: "AppPricePointsV3GetInstanceAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAppPricePointsV3GetInstanceRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AppStoreConnect.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AppPricePointsV3GetInstance",
                                methodName: "AppPricePointsV3GetInstanceAsync",
                                pathTemplate: "$\"/v3/appPricePoints/{id}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAppPricePointsV3GetInstanceResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAppPricePointsV3GetInstanceResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::AppStoreConnect.AppPricePointV3Response.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.AppPricePointV3Response>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::AppStoreConnect.AppPricePointV3Response.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
