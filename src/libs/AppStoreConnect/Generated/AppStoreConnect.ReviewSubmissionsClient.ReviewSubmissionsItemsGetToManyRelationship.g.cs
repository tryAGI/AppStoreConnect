...
namespace AppStoreConnect
{
    public partial class ReviewSubmissionsClient
    {
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement s_ReviewSubmissionsItemsGetToManyRelationshipSecurityRequirement0 =
        ...
        private static readonly global::AppStoreConnect.EndPointSecurityRequirement[] s_ReviewSubmissionsItemsGetToManyRelationshipSecurityRequirements =
            new global::AppStoreConnect.EndPointSecurityRequirement[]
            {                s_ReviewSubmissionsItemsGetToManyRelationshipSecurityRequirement0,
            };
        partial void PrepareReviewSubmissionsItemsGetToManyRelationshipArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? limit,
            ref string id);
        partial void PrepareReviewSubmissionsItemsGetToManyRelationshipRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? limit,
            string id);
        partial void ProcessReviewSubmissionsItemsGetToManyRelationshipResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReviewSubmissionsItemsGetToManyRelationshipResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.ReviewSubmissionItemsLinkagesResponse> ReviewSubmissionsItemsGetToManyRelationshipAsync(
            string id,
            int? limit = default,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ReviewSubmissionsItemsGetToManyRelationshipAsResponseAsync(
                id: id,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AppStoreConnect.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.ReviewSubmissionItemsLinkagesResponse>> ReviewSubmissionsItemsGetToManyRelationshipAsResponseAsync(
            string id,
            int? limit = default,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareReviewSubmissionsItemsGetToManyRelationshipArguments(
            ...
            var __authorizations = global::AppStoreConnect.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ReviewSubmissionsItemsGetToManyRelationshipSecurityRequirements,
                operationName: "ReviewSubmissionsItemsGetToManyRelationshipAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareReviewSubmissionsItemsGetToManyRelationshipRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AppStoreConnect.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ReviewSubmissionsItemsGetToManyRelationship",
                                methodName: "ReviewSubmissionsItemsGetToManyRelationshipAsync",
                                pathTemplate: "$\"/v1/reviewSubmissions/{id}/relationships/items\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessReviewSubmissionsItemsGetToManyRelationshipResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AppStoreConnect.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessReviewSubmissionsItemsGetToManyRelationshipResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::AppStoreConnect.ReviewSubmissionItemsLinkagesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::AppStoreConnect.AutoSDKHttpResponse<global::AppStoreConnect.ReviewSubmissionItemsLinkagesResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::AppStoreConnect.ReviewSubmissionItemsLinkagesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        /// <summary>
        /// Wraps ReviewSubmissionsItemsGetToManyRelationshipAsync as an IAsyncEnumerable&lt;global::AppStoreConnect.ReviewSubmissionItemsLinkagesResponseDataItem&gt; that follows the response's next-page URL.
        /// </summary>
        /// <param name="limit"></param>
        /// <param name="id"></param>
        /// <param name="requestOptions">Options forwarded to every page request.</param>
        /// <param name="cancellationToken"></param>
        public global::System.Collections.Generic.IAsyncEnumerable<global::AppStoreConnect.ReviewSubmissionItemsLinkagesResponseDataItem> ReviewSubmissionsItemsGetToManyRelationshipAutoPagingAsync(
            string id,             int? limit = default,
            global::AppStoreConnect.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::AppStoreConnect.AutoSDKPager.NextUrlAsync<global::AppStoreConnect.ReviewSubmissionItemsLinkagesResponse, global::AppStoreConnect.ReviewSubmissionItemsLinkagesResponseDataItem>(
                fetchPage: (__nextUrl, __ct) => ReviewSubmissionsItemsGetToManyRelationshipAsync(
                    limit: limit,
                    id: id,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::AppStoreConnect.ReviewSubmissionItemsLinkagesResponseDataItem>?)__response.Data,
