...
The AppStoreConnect SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package AppStoreConnect
```
...
using var client = new AppStoreConnectClient(
    apiKey: Environment.GetEnvironmentVariable("APPSTORECONNECT_API_KEY")!);
